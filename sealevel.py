...
if st.checkbox("Show MLLW"):
    fig.add_trace(go.Surface(z=np.full(st.session_state.elevation_data.shape, mllw),x=st.session_state.lon, y=st.session_state.lat,ss showscale=False, opacity=0.5, colorscale=[[0, 'blue'], [1, 'blue']], name='MLLW'))
