...
mllw = -4.43
mhhw = mllw + 14.56
max_tide = st.slider('Max Tide Level', 5.0, 20.0, 5) - 4.43
...
fig.add_trace(go.Surface(z=np.full(st.session_state.elevation_data.shape, mhhw),x=st.session_state.lon, y=st.session_state.lat, showscale=False, opacity=0.5, colorscale=[[0, 'red'], [1, 'red']], name='MHHW'))
